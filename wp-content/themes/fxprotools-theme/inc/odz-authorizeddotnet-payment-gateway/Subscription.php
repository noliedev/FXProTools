...
class Braintree_Subscription extends Braintree
{
    ...
    {
        return Odz_Braintree_Configuration::gateway()->subscription()->create($attributes);
    }

    public static function find($id)
    {
        return Odz_Braintree_Configuration::gateway()->subscription()->find($id);
    }

    public static function search($query)
    {
        return Odz_Braintree_Configuration::gateway()->subscription()->search($query);
    }

    public static function fetch($query, $ids)
    {
        return Odz_Braintree_Configuration::gateway()->subscription()->fetch($query, $ids);
    }

    public static function update($subscriptionId, $attributes)
    {
        return Odz_Braintree_Configuration::gateway()->subscription()->update($subscriptionId, $attributes);
    }

    public static function retryCharge($subscriptionId, $amount = null)
    {
        return Odz_Braintree_Configuration::gateway()->subscription()->retryCharge($subscriptionId, $amount);
    }

    public static function cancel($subscriptionId)
    {
		//var_dump(Odz_Braintree_Configuration);
	//echo 'Cancelled Called';exit;
        return Odz_Braintree_Configuration::gateway()->subscription()->cancel($subscriptionId);
    }
}
