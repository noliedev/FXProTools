			...
			<div class="col-md-5">
				<div class="fx-board checklist cancellation-list">
					<ul class="fx-board-list">
						<li>
							<a href="<?php echo get_option('home'); ?>/cancel-step-2/?option=missing-features">
								<span class="fx-checkbox"></span>
								<span class="fx-text">Missing Features</span>
							</a>
						</li>
						<li>
							<a href="<?php echo get_option('home'); ?>/cancel-step-2/?option=switching">
								<span class="fx-checkbox"></span>
								<span class="fx-text">Switching To Another Product Or Service</span>
							</a>
						</li>
						<li>
							<a href="<?php echo get_option('home'); ?>/cancel-step-2/?option=not-using">
								<span class="fx-checkbox"></span>
								<span class="fx-text">Not Using It Enough</span>
							</a>
						</li>
						<li>
							<a href="<?php echo get_option('home'); ?>/cancel-step-2/?option=forex">
								<span class="fx-checkbox"></span>
								<span class="fx-text">I'm Not Doing Forex Anymore</span>
							</a>
						</li>
						<li>
							<a href="<?php echo get_option('home'); ?>/cancel-step-2/?option=bugs">
								<span class="fx-checkbox"></span>
								<span class="fx-text">Bugs or Support Problems</span>
							</a>
						</li>
						<li>
							<a href="<?php echo get_option('home'); ?>/cancel-step-2/?option=other">
								<span class="fx-checkbox"></span>
