	...
	<?php else: ?>
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="fx-header-title">
						<h1>Oh Man! It Looks like You Don't Have<br/> Access To The Market Scanner</h1>
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-body" style="padding: 50px;">
							<div class="fx-video-container"></div>
							<br/>
							<a href="<?php bloginfo('url');?>/product/professional/" class="btn btn-lg btn-danger block">Upgrade Account</a>
						</div>
					</div>
				</div>
			</div>
