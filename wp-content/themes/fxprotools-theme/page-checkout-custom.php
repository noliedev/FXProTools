					...
					<div class="checkout-left">
						<div class="checkout-form">
							<div class="panel panel-default">
								<div class="panel-heading">STEP 1: ENTER ACCOUNT DETAILS</div>
								<div class="panel-body">
									<div class="form-group row">
							 		...
							 		<div class="form-group row">
								    	...
								    	<div class="col-md-3 right-no-pad">
								     		<select class="form-control">
												...
												<option>+358 �land Islands</option>
												...
												<option>+47 Bouvet Island</option>
												...
												<option>+618 Christmas Island</option>
												<option>+61 Cocos (Keeling) Islands</option>
												<option>+57 Colombia</option>
												<option>+269 Comoros</option>
												<option>+242 Congo</option>
												<option>+243 Congo, Democratic Republic</option>
												<option>+682 Cook Islands</option>
												<option>+506 Costa Rica</option>
												<option>+225 C�te d'Ivoire (Ivory Coast)</option>
												<option>+385 Croatia</option>
												<option>+53 Cuba</option>
												<option>+599 Cura?ao </option>
												...
												<option>+56 Easter Island </option>
												...
												<option>+596 French Guiana</option>
												<option>+594 French Polynesia</option>
												<option>+689 French Southern Territories</option>
												...
												<option>+672 Heard and McDonald Islands</option>
												...
												<option>+856 Lao People's Democratic Republic</option>
												...
												<option>+27 South Africa</option>
												<option>+500 South Georgia and the South Sandwich Islands</option>
												<option>+34 Spain</option>
												<option>+94 Sri Lanka</option>
												<option>+249 Sudan</option>
												<option>+597 Suriname</option>
												<option>+47 Svalbard and Jan Mayen Islands</option>
												...
												<option>+1868 Trinidad Tobago</option>
												...
												<option>+1340 Virgin Islands (US)</option>
												<option>+808 Wallis and Futuna Islands</option>
												<option>+681 Western Sahara</option>
												<option>+967 Yemen</option>
												<option>+260 Zaire</option>
												<option>+255 Zambia</option>
												<option>+263 Zimbabwe</option>
											</select>
								    	</div>
								    	<div class="col-md-6">
											<input value="" placeholder="Enter Your Mobile Phone Number" name="phone" class="form-control" type="text">
										</div>
							 		</div>
							 		<div class="form-group row">
							 			<div class="col-md-9 col-md-offset-3">
											<input  type="checkbox">
											Yes, I don't want to miss important text updates
										</div>
							 		</div>
							 		
									<div class="form-group row">
								    	<label class="col-md-3 col-form-label">Your New Password:</label>
								    	<div class="col-md-9">
								     		<input type="text" class="form-control" placeholder="Your New Password Here...">
								    	</div>
							 		</div>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">STEP 2: ENTER BILLING ADDRESS</div>
								<div class="panel-body">
									<div class="form-group row">
							 		...
							 		<div class="form-group row">
								    	...
								    	<div class="col-md-5 right-no-pad field-mobile-m">
								     		<input type="text" class="form-control" placeholder="State / Province...">
								    	</div>
								    	<label class="col-md-1 col-form-label">ZIP:</label>
								    	<div class="col-md-3">
							 		...
							 		<div class="form-group row">
								    	...
								    	<div class="col-md-9">
								     		<select name="country" class="form-control">
												<option value="Philippines" selected="">Philippines</option><option value="">------------------------------</option>
							 ...
							 <div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="form-group row">
								    	...
								    	<div class="col-md-5 field-mobile-m">
							 		...
							 		<div class="form-group row">
									    ...
									    <div class="col-md-9">
										    <div class="row ">
										    	<div class="col-md-4 field-with-popover field-mobile-m">
										     		<input type="text" class="form-control" placeholder="CVV">
										     		<button class="popover-label" data-trigger="hover" data-toggle="popover" data-html="true" data-placement="top" data-content="<img src='<?php echo get_stylesheet_directory_uri(); ?>/assets/img/ccv-info.png'>">?</button>
										    	</div>
										    	<label class="col-md-3 col-form-label label-pad">Expiry Date:</label>
										    	...
										    	<div class="col-md-3">
											    	<select class="form-control" name="credit_card_exp_date_year">
														<option value="">- Select -</option>
														<option>2017</option>
														<option>2018</option>
														<option>2019</option>
							 ...
							 <div class="panel panel-default panel-gray">
								<div class="panel-body">
									...
									<ul id="product-ordered-list">
										<li>
											<div class="col-md-8 col-xs-8">30 Day <span>ASPIRE </span>Course </div>
											<div class="col-md-4 col-xs-4 text-right">$37.00</div>
										</li>
									</ul>
...
$customer_notif = array
(
  	array(
  		"image" => "https://s3.amazonaws.com/da-my/proof/229/map_229448.png",
  		"name" => "Robert from Eustis, FL",
  		"activity" => "Recently joined..",
  		"time" => "5 minutes ago"
  	),
  	array(
  		"image" => "https://s3.amazonaws.com/da-my/proof/229/map_229448.png",
  		"name" => "Nelson from Cuba, New Mexico, FL",
  		"activity" => "Recently joined..",
  		"time" => "7 minutes ago"
  	),
  	array(
  		"image" => "https://s3.amazonaws.com/da-my/proof/229/map_229448.png",
  		"name" => "David from Greate, FL",
  		"activity" => "Recently joined..",
  		"time" => "8 minutes ago"
  	) 
);
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		var customer_notif = <?php echo json_encode($customer_notif) ?>;
