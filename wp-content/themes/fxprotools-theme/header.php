	...
	<nav class="navbar fx-navbar-sub">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<ul class="fx-nav-options">
						<li class="dashboard"><a href="#" title="Dashboard Icon"><i class="fa fa-bars" aria-hidden="true"></i></a></li>
						<li><a href="#">1.) User Orientation</a></li>
						<li class="locked"><a href="#">2.) Products </a></li>
						<li class="locked"><a href="#">3.) Refer 2 Program</a></li>
					</ul>
				</div>
			</div>
		</div>
