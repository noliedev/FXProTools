...
class AffiliateWP_Activation {
    ...
    public function missing_affiliatewp_notice() {
        ...
        if ( $this->has_affiliatewp ) {
           echo '<div class="error"><p>' . sprintf( __( '%s requires %s. Please activate it to continue.', 'affiliatewp-pb' ), $this->plugin_name, '<a href="http://affiliatewp.com/" title="AffiliateWP" target="_blank">AffiliateWP</a>' ) . '</p></div>'; 

        } else {
            echo '<div class="error"><p>' . sprintf( __( '%s requires %s. Please install it to continue.', 'affiliatewp-pb' ), $this->plugin_name, '<a href="http://affiliatewp.com/" title="AffiliateWP" target="_blank">AffiliateWP</a>' ) . '</p></div>';
        }
    }
}