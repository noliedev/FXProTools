		...
		function init_shortcodes_section_fields() {
			$this->shortcodes_option_fields = array(
				'field' => array(
					...
					'help_text'		=>	__( 'This parameter determines the information to be shown by the shortcode.', 'learndash' ),
					'value' 		=> 	'ID',
