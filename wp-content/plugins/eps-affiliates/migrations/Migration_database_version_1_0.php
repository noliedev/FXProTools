 ...
 class Migration_database_version_1_0 {
		...
		private function afl_user_genealogy(){
			...
			$sql = "CREATE TABLE IF NOT EXISTS `$table_name` (
					  ...
					  `extra_params` varchar(250) DEFAULT '' COMMENT 'Extra Params',
					  `project_name` varchar(250) DEFAULT 'default' COMMENT 'Project name',
					  `rig_count` int(11) DEFAULT '0' COMMENT 'Count of RIGS',
					  `card_count` int(11) DEFAULT '0' COMMENT 'Count of Cards',
					  `registered` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Registered User (1 => registered, 2=> Not direct registerd)',
					  `card_02_count` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '0.2 Card Count'
