	...
	class Eps_Affiliates_Admin_Menu {
		...
		*/
			public function __construct() {
				...
				add_action( 'admin_menu', array( $this , 'compensation_config_menus') );
				add_action( 'admin_menu', array( $this , 'config_roles_and_permissions') );
		...
		*/	
			public function advanced_config_menus() {
				...
				$menu['advanced_config'] = array(
					...
					'#access_callback'=> 'advanced_configurations', 
					'#menu_slug' 			=> 'advanced-configurations', 
		...
		*/
		...
		/*
		 * -------------------------------------------------------------------------
		 * Configuration for set roles and permissions
		 * -------------------------------------------------------------------------
		*/
			public function config_roles_and_permissions(){
				$menu = array();
